# capstone-ccmp-johnaaronelorde
 Source code for your Lambda function and Step Functions state machine.
...
- Node.js runtime with `sharp` library for image resizing in Lambda  
...
- Develop your Lambda function to:  
  ...
  - Resize images using `sharp` or Pillow (Used Node.js - Sharp for my application) 
